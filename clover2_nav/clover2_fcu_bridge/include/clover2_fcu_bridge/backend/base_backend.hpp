...
public:
    ...
    virtual std::optional<data::fcu_state> get_fcu_state() const;
    virtual std::optional<sensor_msgs::msg::BatteryState> get_power() const;
    virtual std::optional<sensor_msgs::msg::Imu> get_imu() const;
    virtual std::optional<sensor_msgs::msg::FluidPressure> get_barometer() const;
