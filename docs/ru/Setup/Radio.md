...
1. Снимите чёрные резиновые накладки с задней стороны аппаратуры управления.
...
## Сопряжение аппаратуры управления с приёмником

1. Переведите приёмник в режим **bind**: трижды подключите и отключите питание полётного контроллера, к которому подключен приёмник ELRS.

```{note}
После перехода в режим сопряжения светодиод на приёмнике начинает мигать двойными импульсами с паузой.
```
