...
RPLidar C1 — это 2D-лидар для кругового сканирования окружающего пространства (см. рисунок 1). Он последовательно измеряет расстояния в разных направлениях и формирует набор точек вокруг датчика в диапазоне 360°.
...
Если рядом нет объекта или отражённый сигнал слишком слабый, измерение может быть некорректным. Такие значения обычно игнорируются алгоритмами навигации и построения карты.

```{figure} @assets@/common/programming/sensors/rplidar/coord-scheme.webp
...
1. Установите RPLidar C1 на монтажную деку из поликарбоната при помощи винтов M2.5x6 (см. рисунок 3).
   ...
   ```{figure} @assets@/ru/programming/sensors/rplidar/assemble-lidar-1.webp
...
2. Установите алюминиевые стойки 40 мм на монтажную деку из поликарбоната при помощи винтов M3х6 (см. рисунок 4).

   ```{figure} @assets@/ru/programming/sensors/rplidar/assemble-lidar-2.webp
...
3. Установите подготовленный RPLidar на алюминиевые стойки с помощью винтов M3х6 (см. рисунок 5).

   ```{figure} @assets@/ru/programming/sensors/rplidar/assemble-lidar-3.webp
