...
drone.offboard.is_armed()     # True/False
drone.offboard.flight_mode()  # режим полёта PX4
```
...
```python
print(drone.offboard.get_position())
```
...
```python
print(drone.offboard.get_position("map_aruco_1"))
```
