...
g2o_install() {
    ...
    log_info "Build g2o"
    cmake -DG2O_BUILD_SLAM3D_TYPES=ON -DG2O_BUILD_BENCHMARKS=OFF -DG2O_BUILD_EXAMPLES=OFF -DG2O_BUILD_APPS=OFF -DG2O_INSTALL_CMAKE_CONFIG=ON -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=/usr .
    make -j$(nproc)
