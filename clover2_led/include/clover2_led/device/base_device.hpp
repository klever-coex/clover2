...
public:
    ...
    const data::driver_info& info() const noexcept;

    void write(const data::led_frame& frame);
...
protected:
    ...
    data::driver_info& info() noexcept;
    ...
    virtual void write_raw_frame(const std::vector<data::color>& colors) = 0;
