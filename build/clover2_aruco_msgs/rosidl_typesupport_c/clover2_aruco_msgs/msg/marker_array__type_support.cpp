...
static const _MarkerArray_type_support_symbol_names_t _MarkerArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, clover2_aruco_msgs, msg, MarkerArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, clover2_aruco_msgs, msg, MarkerArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, clover2_aruco_msgs, msg, MarkerArray)() {
  return &::clover2_aruco_msgs::msg::rosidl_typesupport_c::MarkerArray_message_type_support_handle;
}
