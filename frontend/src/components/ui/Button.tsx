...
export const buttonBase =
  'inline-flex items-center justify-center gap-2 font-medium rounded-row transition-colors duration-fast focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-royal/60 disabled:opacity-50 disabled:pointer-events-none';
