...
using namespace clover2_http_plugins::data;
...
struct stream_state {
    ...
    clover2_http_plugins::utils::message_type type;
    clover2_http_plugins::utils::rate_limiter limiter;
    std::unique_ptr<clover2_http_plugins::utils::universal_subscriber>
        subscriber;
};
...
std::optional<nlohmann::json> deserialize_message(
    ...
    try {
        ...
        j = clover2_http_plugins::utils::msg_json::detail::to_json(
...
void ros_support::handle_topic_json_stream(
    ...
    try {
        ...
        state->subscriber =
            std::make_unique<clover2_http_plugins::utils::universal_subscriber>(
